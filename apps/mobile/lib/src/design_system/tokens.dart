...
abstract class LCColors {
  ...
  static const Color trustNavy =
      Color(0xFF0D2B45); // Headers, primary text (dark)
  ...
  static const Color escalationRose =
      Color(0xFFEF5350); // Exception Alert / Danger
...
abstract class LCTextStyles {
  static const String fontFamily =
      'SF Pro Display'; // iOS; Roboto fallback on Android
...
abstract class LCRadius {
  ...
  static const double full = 999; // For pill shapes
}
