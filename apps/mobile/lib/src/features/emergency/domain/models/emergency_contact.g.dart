...
void _emergencyContactSerialize(
  ...
  writer.writeString(offsets[1], object.householdId);
...
EmergencyContact _emergencyContactDeserialize(
  ...
  object.householdId = reader.readString(offsets[1]);
  object.id = id;
...
extension EmergencyContactByIndex on IsarCollection<EmergencyContact> {
  Future<EmergencyContact?> getByUuid(String uuid) {
    return getByIndex(r'uuid', [uuid]);
  }

  EmergencyContact? getByUuidSync(String uuid) {
  ...
  Future<List<EmergencyContact?>> getAllByUuid(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
    return getAllByIndex(r'uuid', values);
  }

  List<EmergencyContact?> getAllByUuidSync(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
  ...
  Future<Id> putByUuid(EmergencyContact object) {
    return putByIndex(r'uuid', object);
  }

  Id putByUuidSync(EmergencyContact object, {bool saveLinks = true}) {
    return putByIndexSync(r'uuid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByUuid(List<EmergencyContact> objects) {
    return putAllByIndex(r'uuid', objects);
  }

  List<Id> putAllByUuidSync(List<EmergencyContact> objects,
      {bool saveLinks = true}) {
...
extension EmergencyContactQuerySortBy
  ...
  QueryBuilder<EmergencyContact, EmergencyContact, QAfterSortBy> sortByRole() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EmergencyContact, EmergencyContact, QAfterSortBy> sortByUuid() {
    return QueryBuilder.apply(this, (query) {
...
extension EmergencyContactQuerySortThenBy
  ...
  QueryBuilder<EmergencyContact, EmergencyContact, QAfterSortBy> thenByRole() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'role', Sort.asc);
    });
  }
  ...
  QueryBuilder<EmergencyContact, EmergencyContact, QAfterSortBy> thenByUuid() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uuid', Sort.asc);
    });
  }
...
extension EmergencyContactQueryWhereDistinct
  ...
  QueryBuilder<EmergencyContact, EmergencyContact, QDistinct> distinctByRole(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EmergencyContact, EmergencyContact, QDistinct> distinctByUuid(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension EmergencyContactQueryProperty
  ...
  QueryBuilder<EmergencyContact, String, QQueryOperations> roleProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EmergencyContact, String, QQueryOperations> uuidProperty() {
    return QueryBuilder.apply(this, (query) {
