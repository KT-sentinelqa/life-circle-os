...
class ResponsibilityCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      color: isEscalated ? theme.colorScheme.errorContainer : theme.colorScheme.surface,
          ...
          children: [
                ...
                Expanded(
                  child: Text(
                    ...
                    style: theme.textTheme.titleMedium?.copyWith(
                      ...
                      color: isEscalated ? theme.colorScheme.onErrorContainer : theme.colorScheme.onSurface,
                    ),
                  ),
                ),
                if (isEscalated)
            ...
            Text(
              ...
              style: theme.textTheme.bodyMedium?.copyWith(
                color: isEscalated ? theme.colorScheme.onErrorContainer : theme.colorScheme.onSurfaceVariant,
              ),
            ),
            ...
            if (responsibility.status == ResponsibilityStatus.pending || 
              ...
              Row(
                ...
                children: [
                  TextButton(
                    onPressed: onSkip,
                    child: Text('Skip', style: TextStyle(color: isEscalated ? theme.colorScheme.error : null)),
                  ),
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text('Completed', style: TextStyle(color: theme.colorScheme.primary, fontWeight: FontWeight.bold)),
                ],
              )
          ],
        ),
