...
void main() {
  ...
  testWidgets('MedicineDashboardScreen Golden', (tester) async {
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: MaterialApp(
          ...
          home: const MedicineDashboardScreen(),
        ),
      ),
    );
    ...
    await expectLater(
      find.byType(MedicineDashboardScreen),
      matchesGoldenFile('medicine_dashboard_screen_light.png'),
    );
  });
}
