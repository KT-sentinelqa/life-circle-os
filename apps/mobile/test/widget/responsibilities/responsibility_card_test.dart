...
import 'package:life_circle_os/src/features/responsibilities/presentation/widgets/responsibility_card.dart';
...
void main() {
  testWidgets('ResponsibilityCard renders accessible escalation state', (WidgetTester tester) async {
