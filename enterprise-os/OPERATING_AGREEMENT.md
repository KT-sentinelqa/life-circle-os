...
**SEC-001:** Mandatory secret scanning on all repositories.
**SEC-002:** SBOM generation for every release artifact.
**SEC-003:** Dependency provenance verification.
**SEC-004:** Signed commits required for production environments.
**SEC-005:** Artifact signing for all published container images and binaries.
